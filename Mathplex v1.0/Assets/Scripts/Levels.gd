...
func level_enter(a: int) -> void:
	...
	elif(Global.Language == 1):
		button1.text = "Nivelul " + str(a*8+1)
		button2.text = "Nivelul " + str(a*8+2)
		button3.text = "Nivelul " + str(a*8+3)
		button4.text = "Nivelul " + str(a*8+4)
		button5.text = "Nivelul " + str(a*8+5)
		button6.text = "Nivelul " + str(a*8+6)
		button7.text = "Nivelul " + str(a*8+7)
		button8.text = "Nivelul " + str(a*8+8)
	page=a
